...
describe('VaultCodesDialog', () => {
  it('lists one code per entry', () => {
    render(<VaultCodesDialog title="Einmal-Codes" hint="H" emptyText="Nichts mehr" entries={entries} onClose={vi.fn()} />);
  ...
  it('renders the given empty text when there is nothing to show', () => {
    render(<VaultCodesDialog title="T" hint="H" emptyText="Nichts zu tun" entries={[]} onClose={vi.fn()} />);
  ...
  it('closes on the acknowledge button', () => {
    const onClose = vi.fn();
    render(<VaultCodesDialog title="T" hint="H" emptyText="Nichts mehr" entries={entries} onClose={onClose} />);
